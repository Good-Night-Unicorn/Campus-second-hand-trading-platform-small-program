<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.shangpinshipin" label="商品视频" prop="shangpinshipin">
          <file-upload
          tip="点击上传商品视频"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.shangpinshipin?ruleForm.shangpinshipin:''"
          @change="shangpinshipinUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.shangpinshipin" label="商品视频" prop="shangpinshipin">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.shangpinshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.guige = true;
          ...
          if(o=='shangpinshipin'){
            this.ruleForm.shangpinshipin = obj[o];
	    this.ro.shangpinshipin = true;
            continue;
          }
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../ssm0m7v0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.shangpinshipin!=null) {
		this.ruleForm.shangpinshipin = this.ruleForm.shangpinshipin.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    shangpinshipinUploadChange(fileUrls) {
	this.ruleForm.shangpinshipin = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
